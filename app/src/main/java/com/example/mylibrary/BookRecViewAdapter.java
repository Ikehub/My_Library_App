...
public class BookRecViewAdapter extends RecyclerView.Adapter<BookRecViewAdapter.ViewHolder>{
    ...
    private static final String LOG_TAG = BookRecViewAdapter.class.getSimpleName();
    public static final String BOOK_ID_KEY = "com.example.mylibrary.bookRecViewAdapter.EXTRA.bookID";
